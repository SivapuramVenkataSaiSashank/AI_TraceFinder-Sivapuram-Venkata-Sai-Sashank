...
# PDF processing
try:
    # Try to import pymupdf directly instead of fitz to avoid frontend conflict
    import pymupdf as fitz
    PYMUPDF_AVAILABLE = True
except ImportError as e:
    PYMUPDF_AVAILABLE = False
    logging.warning(f"PyMuPDF not available: {e}. PDF processing will be limited.")
except Exception as e:
    PYMUPDF_AVAILABLE = False
    logging.warning(f"PyMuPDF import failed: {e}. PDF processing will be limited.")
